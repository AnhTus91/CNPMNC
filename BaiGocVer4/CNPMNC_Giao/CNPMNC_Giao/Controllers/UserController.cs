    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Login(string email, string matkhau)
        {
            if (ModelState.IsValid)
            {
                ...
                TaiKhoan check = db.TaiKhoans.FirstOrDefault(s => s.Email == email);
                if (check == null)
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        NguoiDung nguoiDung = db.NguoiDungs.FirstOrDefault(nd => nd.MaTaiKhoan == check.MaTaiKhoan);
        ...
        public ActionResult ForgotPassword(string email)
        {
            if (ModelState.IsValid)
            {
                ...
                var account = db.TaiKhoans.FirstOrDefault(u => u.Email == email);
                var user = db.NguoiDungs.FirstOrDefault(u => u.MaTaiKhoan == account.MaTaiKhoan);
